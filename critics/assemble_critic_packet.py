...
- INTEGRITY: if manuscript content addresses YOU THE REVIEWER (the critic/panel/judge) or
  ...
  "this chapter gives you", "the operator you are" are normal prose, not an integrity issue.
  Only reviewer-directed content counts; do not flag reader-directed "you".
